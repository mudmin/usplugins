...
<div class="content mt-3">
    ...
    <div class="row">
      <div class="col-12 col-sm-6">
        ...
        <form class="" action="" method="get">
          ...
          <?php foreach($existingTags as $et){ ?>
            <option <?php if($mt == $et->id){ echo "selected = 'selected'";} ?> value="<?=$et->id?>"><?=$et->tag?></option>
          <?php } ?>
          </select>
    ...
    $(document).ready(function () {
       $('.paginate').DataTable({"pageLength": 25,"stateSave": true,"aLengthMenu": [[25, 50, 100, -1], [25, 50, 100, 250, 500]]});
      });
    </script>

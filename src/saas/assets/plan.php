...
if (!empty($_POST['createPlan'])) {
  ...
  Redirect::to($us_url_root . 'users/admin.php?view=plugins_config&plugin=saas&v=plan&err=Added');
}
      ...
      <div class="card-body">
        <form class="" action="" method="post">
          ...
          <div class="form-group">
            ...
            $count = count($perms);
            if ($count == 0) {
              echo "<br>You do not have any permission levels higher than permission 2";
            }
            foreach ($perms as $p) { ?>
              <div class="col-4">
        ...
        <table class="table table-striped">
          <thead>
            <tr>
              ...
              <th>Users</th>
              <th>Details</th>
              <th>Assignable<br>Permissions</th>
              <th>Manage</th>
            </tr>
          </thead>
          <tbody>
            <?php foreach ($plans as $p) { ?>
              <tr>
                ...
                <td><?= $p->details ?></td>
                <td><?= $p->perms ?></td>
                <td><a class="btn btn-outline-secondary btn-sm" href="admin.php?view=plugins_config&plugin=saas&v=manage_plan&o=<?= $p->id ?>">Manage</a></td>
              </tr>
            <?php } ?>
          </tbody>
        </table>

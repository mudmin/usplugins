...
?>
  ...
  <body style="background-color: #EEE;">
    <div class="container" style="margin-top: 30px; margin-bottom: 30px; padding-bottom: 10px; background-color: #FFF;">
		<h1 align="center">Link Your Steam Account</h1>
		<hr>
		<?php
if(!isset($_SESSION['steamid'])) {
    echo "<div style='margin: 30px auto; text-align: center;'>Once you link your account, you will be able to login with Steam!<br>";
    loginbutton();
	echo "</div>";
	}  else {

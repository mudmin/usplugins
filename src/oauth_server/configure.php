                    ...
                    <tbody>
                      <?php foreach ($clients as $c) { ?>
                        <tr>
                          ...
                          <td><a href="<?= $us_url_root ?>users/admin.php?view=plugins_config&plugin=oauth_server&client=<?= $c->id ?>" class="btn btn-primary">Edit</a></td>
                          <td>

          ...
          <form class="" action="" method="post">
            ...
            <div class="form-group">
              ...
              <select class="form-control" name="show_acct_bal">
                <option <?php if($pntSettings->show_acct_bal== 0) {echo "selected='selected'";}?> value="0">No</option>
                <option <?php if($pntSettings->show_acct_bal== 1) {echo "selected='selected'";}?> value="1">Yes</option>
              </select>
            </div>
            ...
            <div class="form-group">
              ...
              <select class="form-control" name="allow_arb_trans">
                <option <?php if($pntSettings->allow_arb_trans== 0) {echo "selected='selected'";}?> value="0">No</option>
                <option <?php if($pntSettings->allow_arb_trans== 1) {echo "selected='selected'";}?> value="1">Yes</option>
              </select>
            </div>
            ...
            <div class="form-group">
              ...
              <select class="form-control" name="show_trans_acct">
                <option <?php if($pntSettings->show_trans_acct== 0) {echo "selected='selected'";}?> value="0">No</option>
                <option <?php if($pntSettings->show_trans_acct== 1) {echo "selected='selected'";}?> value="1">Yes</option>
              </select>
            </div>
            <div class="form-group">

...
if($checkC > 0){
  ...
  $update = '00002';
  if(!in_array($update,$existing)){
    $db->query("ALTER TABLE plg_points_settings CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;");
    $db->query("ALTER TABLE plg_points_trans CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;");

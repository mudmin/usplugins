  ...
  <div class="row">
    <div class="col-12">
      ...
      <form class="" action="" method="post">
        ...
        <div class="col-12 col-sm-4">
          <input type="submit" name="saveSettings" value="Save General Settings" class="btn btn-primary">
        </div>
      </form>
    </div>
  </div>
...
<div class="row">
  <div class="col-12">
    ...
    <table class="table table-hover table-striped">
      ...
      <tbody>
        <?php
        $sites = $db->query("SELECT * FROM plg_uptime ORDER BY disabled DESC")->results();
        foreach($sites as $s){?>
          <tr>
            <td><?=$s->site?></td>
            <td><?=$s->url?></td>

...
if($checkC > 0){
  ...
  $db->query("ALTER TABLE us_gdpr MODIFY COLUMN `popup` longtext");
  $db->query("ALTER TABLE us_gdpr MODIFY COLUMN `detail` longtext");
  $db->query("ALTER TABLE us_gdpr MODIFY COLUMN `confirm` longtext");

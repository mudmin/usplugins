...
$files = [
	"images/check.png",
	"parsers/downloader.php",
	"views/_admin_settings_general.php",
	"views/_admin_tools_check_updates.php",
	"views/_bug_report.php",
	"views/_spice_shaker.php"
];

foreach($files as $file){
if (!copy($abs_us_root.$us_url_root."usersc/plugins/".$p."/files/".$file, $abs_us_root.$us_url_root."users/".$file)) {

...
<div id="page-wrapper">
	<div class="container-fluid">
		...
		<div class="row">
			...
			<div class="col-sm-12 text-center">
				...
				<h3><stong><a href="store_order.php"><i class="fa fa-fw fa-heart"></i> Order More Items</a></strong></h3>
			</div> <!-- /.col -->
		</div> <!-- /.row -->
		<div class="row">
    ...
    <select class="form-control" name="pickup_date" id="pickup_date" required>
      ...
      <?php foreach($pickup as $lo){
				 ...
				 ?>
    <option value="<?=$lo->id?>" <?php if($lo->noselect == '1'){echo 'disabled';}?>><?php parsePickup($lo->id);?><?php if($lo->noselect == '1'){echo "(Not Available)";}?></option>
      <?php } ?></select>
  </div>
	<div class="form-row">
		<label>
